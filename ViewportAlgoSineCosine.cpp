...
#include<stdio.h>
#define pie 3.1412
void transform (float minang, float maxang, int option, int l,
int b, int t, int r);
void main(){
int option, l, b, t, r;
...
/************************************************************/
void transform (float minang, float maxang, int option,int l, int
t, int r, int b){
float temp, x, y, xmax, ymax, xmin, ymin, sxmax, symax, sxmin,
symin;
double sx, sy;
sxmin = l; sxmax = r;
symin = t; symax = b;
